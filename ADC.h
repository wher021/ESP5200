...
void Initialise_ADC()
{
	...
	ADMUX = 0b01100000;	// AVCC REF, Left-adjust output (Read most-significant 8 bits via ADCH), Convert channel 0 (ADC0) Pin PF0
...
{
	raw_Analog_values = ADCH;//store raw analog values
}
